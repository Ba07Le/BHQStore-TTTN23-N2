...
const editOptions=['Đang chờ xử lý', 'Đã gửi', 'Đang giao hàng', 'Đã giao', 'Đã hủy']
            ...
            <Table aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="left">Mặt hàng</TableCell>
...
<Typography>{order.address[0].state}</Typography>
                    ...
                    <TableCell align="right">
                        ...
                        <FormControl fullWidth>
                          ...
                          <Select
                            ...
                            label="Update status"
                            {...register('status',{required:'Cần cập nhật trạng thái'})}
                            >
          ...
          <Stack width={is480?"auto":'30rem'} justifyContent={'center'}>
            ...
            <Stack rowGap={'1rem'}>
                ...
                <Typography textAlign={'center'} alignSelf={'center'} variant='h6' fontWeight={400}>Hiện tại không có đơn hàng nào</Typography>
            </Stack>
